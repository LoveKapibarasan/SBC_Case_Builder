...
open top case for SSI-EEB / E-ATX / ATX motherboards, printable on a **220 x 220 mm**
bed.
...
| `post` | 4 | 14.00 | 14.00 | 200.00 | 38.8 cm3 each |
| `key` | 26 | 23.80 | 11.75 | 3.80 | 0.8 cm3 each |
...
| 26 keys | 21 cm3 | ~0.03 kg |
| **sides total** | **1095 cm3** | **~1.36 kg** |
| base panel, for reference | 311 cm3 | ~0.39 kg |
| **whole case** | **~1406 cm3** | **~1.75 kg** |

That is close to two 1 kg spools and a lot of print time. To cut it down:

- `wall_field_t = 2` and `cell_size = 12`, `cell_wall = 2` for a lighter vent field
- lower `case_height` if your cooler is short
- hollow posts would save little; the walls are 84 % of the side material
